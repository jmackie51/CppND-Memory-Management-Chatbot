...
//// STUDENT CODE Rule of Five Task 2
////
...
ChatBot &ChatBot::operator=(const ChatBot &source) // copy assignment constructor
{
    ...
    _image = new wxBitmap();
    *_image = *source._image;
    std::cout << "ChatBot Copy Assignment Constructor " << &source << " to instance " << this << std::endl;
    return *this;
...
ChatBot &ChatBot::operator=(ChatBot &&source)  //move assignment constructor
{
   ...
   _chatLogic->SetChatbotHandle(this);
   source._chatLogic = nullptr; 
   std::cout << "ChatBot Move Assignment Constructor " << &source << " to instance " << this << std::endl;

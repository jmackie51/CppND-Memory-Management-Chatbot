    ...
    : wxScrolledWindow(parent, id)
{
    ...
    //Task 1
    _chatLogic = std::make_unique<ChatLogic>(); //use unique pointer to allocate memory on heap for Chatlogic instance
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
    ...
    //delete _chatLogic; //Is now a uniqie ptr so no need to delete
